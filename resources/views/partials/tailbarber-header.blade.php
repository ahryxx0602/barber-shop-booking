...
>
  <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
    <div class="flex w-full items-center justify-between gap-2 border-b border-gray-200 px-3 py-3 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4 dark:border-gray-800">
      ...
      <!-- Mobile Logo -->
      <a href="{{ route('barber.dashboard') }}" class="flex items-center gap-1 lg:hidden">
        <span class="text-lg">✂️</span>
        <span class="font-bold text-gray-800 dark:text-white">BarberBook</span>
      </a>
    ...
    >
      ...
      >
        ...
        >
          <span class="flex h-9 w-9 items-center justify-center rounded-full bg-brand-100 text-brand-700 font-semibold text-sm dark:bg-brand-900 dark:text-brand-300">
            {{ strtoupper(substr(auth()->user()->name, 0, 1)) }}
          </span>
          <span class="hidden text-sm font-medium lg:block">{{ auth()->user()->name }}</span>
          <svg
            :class="dropdownOpen && 'rotate-180'"
            class="stroke-gray-500 dark:stroke-gray-400 transition-transform"
        ...
        <div
          x-show="dropdownOpen"
          x-transition
          class="absolute right-0 mt-4 flex w-[220px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-lg dark:border-gray-800 dark:bg-gray-900"
        >
          ...
          <ul class="flex flex-col gap-1 pb-3 border-b border-gray-100 dark:border-gray-800">
            <li>
              <a
              ...
              >
                <svg class="fill-gray-500 group-hover:fill-gray-700 dark:fill-gray-400" width="20" height="20" viewBox="0 0 24 24" fill="none">
