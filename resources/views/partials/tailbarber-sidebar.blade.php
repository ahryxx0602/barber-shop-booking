<aside :class="sidebarToggle ? 'translate-x-0 lg:w-[90px]' : '-translate-x-full'"
  ...
  <div :class="sidebarToggle ? 'justify-center' : 'justify-between'" class="flex items-center gap-2 pt-8 pb-7">
    <a href="{{ route('barber.dashboard') }}">
      <span :class="sidebarToggle ? 'hidden' : 'flex'" class="items-center gap-2.5">
        ...
        <span class="text-lg font-bold text-gray-800 dark:text-white">Classic Cut</span>
      </span>
      <span :class="sidebarToggle ? 'lg:flex' : 'hidden'" class="items-center justify-center">
  ...
  <div class="flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar">
    <!-- Sidebar Menu -->
    <nav x-data="{ selected: $persist('BarberDashboard') }">

      <!-- Menu Group: QUẢN LÝ -->
      <div>
        <h3 class="mb-4 text-xs uppercase leading-5 text-gray-400">
          <span :class="sidebarToggle ? 'lg:hidden' : ''">QUẢN LÝ</span>
          <svg :class="sidebarToggle ? 'lg:block hidden' : 'hidden'" class="mx-auto fill-current" width="24" height="24"
        ...
        <ul class="flex flex-col gap-4 mb-6">
          ...
          <!-- Menu: Dashboard -->
          <li>
            <a href="{{ route('barber.dashboard') }}" @click="selected = 'BarberDashboard'" class="menu-item group"
              :class="selected === 'BarberDashboard' ? 'menu-item-active' : 'menu-item-inactive'">
              <svg :class="selected === 'BarberDashboard' ? 'menu-item-icon-active' : 'menu-item-icon-inactive'"
          ...
          <!-- Menu: Lịch làm việc -->
          <li>
            <a href="{{ route('barber.schedule.edit') }}" @click="selected = 'LichLam'" class="menu-item group"
              ...
              <svg :class="selected === 'LichLam' ? 'menu-item-icon-active' : 'menu-item-icon-inactive'" width="24"
                ...
                <path fill-rule="evenodd" clip-rule="evenodd"
                  d="M6.75 2.5C6.75 2.08579 7.08578 1.75 7.5 1.75C7.91421 1.75 8.25 2.08579 8.25 2.5V3.25H15.75V2.5C15.75 2.08579 16.0858 1.75 16.5 1.75C16.9142 1.75 17.25 2.08579 17.25 2.5V3.25H19C20.2426 3.25 21.25 4.25736 21.25 5.5V19.5C21.25 20.7426 20.2426 21.75 19 21.75H5C3.75736 21.75 2.75 20.7426 2.75 19.5V5.5C2.75 4.25736 3.75736 3.25 5 3.25H6.75V2.5ZM15.75 4.75V5.5C15.75 5.91422 16.0858 6.25 16.5 6.25C16.9142 6.25 17.25 5.91422 17.25 5.5V4.75H19C19.4142 4.75 19.75 5.08579 19.75 5.5V8.25H4.25V5.5C4.25 5.08579 4.58579 4.75 5 4.75H6.75V5.5C6.75 5.91422 7.08578 6.25 7.5 6.25C7.91421 6.25 8.25 5.91422 8.25 5.5V4.75H15.75ZM4.25 9.75V19.5C4.25 19.9142 4.58579 20.25 5 20.25H19C19.4142 20.25 19.75 19.9142 19.75 19.5V9.75H4.25ZM7.5 12.25C7.08579 12.25 6.75 12.5858 6.75 13C6.75 13.4142 7.08579 13.75 7.5 13.75H8.5C8.91421 13.75 9.25 13.4142 9.25 13C9.25 12.5858 8.91421 12.25 8.5 12.25H7.5ZM11.25 13C11.25 12.5858 11.5858 12.25 12 12.25H12.01C12.4242 12.25 12.76 12.5858 12.76 13C12.76 13.4142 12.4242 13.75 12.01 13.75H12C11.5858 13.75 11.25 13.4142 11.25 13ZM16.5 12.25C16.0858 12.25 15.75 12.5858 15.75 13C15.75 13.4142 16.0858 13.75 16.5 13.75H16.51C16.9242 13.75 17.26 13.4142 17.26 13C17.26 12.5858 16.9242 12.25 16.51 12.25H16.5ZM6.75 17C6.75 16.5858 7.08579 16.25 7.5 16.25H8.5C8.91421 16.25 9.25 16.5858 9.25 17C9.25 17.4142 8.91421 17.75 8.5 17.75H7.5C7.08579 17.75 6.75 17.4142 6.75 17ZM12 16.25C11.5858 16.25 11.25 16.5858 11.25 17C11.25 17.4142 11.5858 17.75 12 17.75H12.01C12.4242 17.75 12.76 17.4142 12.76 17C12.76 16.5858 12.4242 16.25 12.01 16.25H12Z" />
              </svg>
          ...
          <!-- Menu: Ngày nghỉ -->
          <li>
            <a href="{{ route('barber.leaves.index') }}" @click="selected = 'Leaves'" class="menu-item group"
              :class="selected === 'Leaves' ? 'menu-item-active' : 'menu-item-inactive'">
              <svg :class="selected === 'Leaves' ? 'menu-item-icon-active' : 'menu-item-icon-inactive'" width="24"
