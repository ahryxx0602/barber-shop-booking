...
<body class="font-sans antialiased">
  <div class="relative bg-white z-1 dark:bg-gray-900">
    <div class="relative flex flex-col w-full min-h-screen dark:bg-gray-900 lg:flex-row">
      ...
      {{-- Form Side --}}
      <div class="flex flex-col w-full min-h-screen p-6 sm:p-0 lg:w-1/2 lg:overflow-y-auto">
      ...
      {{-- Branding Side - fixed full height --}}
      <div class="hidden lg:block lg:w-1/2 lg:fixed lg:right-0 lg:top-0 lg:bottom-0 overflow-hidden animated-gradient">
        {{-- Decorative circles --}}
        <div class="absolute -top-24 -right-24 w-96 h-96 rounded-full opacity-10 float-circle-1"
          style="background: radial-gradient(circle, #ff6b81 0%, transparent 70%);"></div>
        <div class="absolute -bottom-32 -left-32 w-[500px] h-[500px] rounded-full opacity-10 float-circle-2"
        ...
        <div class="flex items-center justify-center h-full relative z-10 px-10">
          <div class="flex flex-col items-center max-w-sm text-center">
            {{-- Logo --}}
            <div
              class="flex items-center justify-center w-20 h-20 rounded-2xl bg-white/10 backdrop-blur-sm mb-8 border border-white/20">
            ...
            <p class="text-base leading-relaxed text-rose-200">
              Hệ thống đặt lịch cắt tóc trực tuyến
            </p>
            <p class="text-sm text-rose-300/70 mt-2">
              Quản lý dịch vụ, thợ cắt và lịch hẹn dễ dàng
            </p>

            {{-- Decorative divider --}}
            <div class="flex items-center gap-3 mt-8">
              <div class="h-px w-12 bg-white/20"></div>
              <svg class="w-5 h-5 text-white/40" viewBox="0 0 24 24" fill="none" stroke="currentColor"
