...
@section('header')
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">Sửa Dịch vụ: {{ $service->name }}</h2>
@endsection
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="3"
                                      class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('description', $service->description) }}</textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="duration_minutes" value="{{ old('duration_minutes', $service->duration_minutes) }}" min="15" max="300"
                                       class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 @error('duration_minutes') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input type="file" name="image" accept="image/*"
                                   class="w-full text-sm text-gray-500 @error('image') border-red-500 @enderror">
                            @error('image')
                                <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <label for="is_active" class="text-sm text-gray-700">Kích hoạt dịch vụ</label>
                        </div>
                    </div>
