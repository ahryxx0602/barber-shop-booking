  ...
  <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
    <div
      ...
      <a href="{{ route('barber.dashboard') }}" class="flex items-center gap-1 lg:hidden">
        ...
        <span class="font-bold text-gray-800 dark:text-white">Classic Cut</span>
      </a>
    ...
    <div :class="menuToggle ? 'flex' : 'hidden'"
      ...
      <div class="flex items-center gap-2 sm:gap-3">
        ...
        <button
          ...
          @click.prevent="darkMode = !darkMode" title="Toggle dark mode">
          ...
          <ul class="flex flex-col gap-1 pb-3 border-b border-gray-100 dark:border-gray-800">
            <li>
              <a href="{{ route('profile.edit') }}"
                ...
                <svg class="fill-gray-500 group-hover:fill-gray-700 dark:fill-gray-400" width="20" height="20"
                  viewBox="0 0 24 24" fill="none">
                  <path fill-rule="evenodd" clip-rule="evenodd"
