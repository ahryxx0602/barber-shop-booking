...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body::before {
            content: '403'; font-family: 'Cormorant Garamond', serif;
        ...
        @keyframes pulse {
            0%, 100% { box-shadow: 0 0 0 0 rgba(176,137,104,0.3); }
            50% { box-shadow: 0 0 0 12px rgba(176,137,104,0); }
        }
        .error-icon .material-symbols-outlined {
            font-size: 36px; color: var(--v-copper);
        }
        .v-ornament {
        ...
        .v-btn-outline {
            ...
            font-family: 'DM Sans', sans-serif; font-size: 12px; font-weight: 600;
            letter-spacing: 2px; text-transform: uppercase; text-decoration: none;
            border: 1px solid var(--v-rule); color: var(--v-ink);
...
<body>
    ...
    <div class="error-container">
        ...
        <p class="subtitle">Bạn không có quyền truy cập trang này</p>
        <p class="description">
            Xin lỗi, tài khoản của bạn không được phép truy cập khu vực này.
            Vui lòng quay lại trang chủ hoặc liên hệ quản trị viên nếu bạn cho rằng đây là lỗi.
        </p>
        ...
        <div class="actions">
            ...
            <a href="javascript:history.back()" class="v-btn-outline">
