@extends('layouts.tailadmin-guest')
        ...
        <div class="flex items-center justify-between">
          <label for="remember_me" class="flex items-center text-sm font-normal text-gray-700 cursor-pointer select-none dark:text-gray-400">
            <input id="remember_me" type="checkbox" name="remember"
              class="mr-3 h-5 w-5 rounded-md border-[1.25px] border-gray-300 text-brand-500 focus:ring-brand-500 dark:border-gray-700 dark:bg-transparent"
            />
            Ghi nhớ đăng nhập
          </label>
