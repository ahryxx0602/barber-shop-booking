...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body::before {
            content: '404'; font-family: 'Cormorant Garamond', serif;
        ...
        .scissors-container::before {
            content: '✂'; font-size: 56px; color: var(--v-copper);
        ...
        .cut-line {
            ...
            border-top: 2px dashed var(--v-copper); opacity: 0.5;
            position: relative;
        }
        .v-ornament {
...
<body>
    ...
    <div class="error-container">
        <div class="scissors-container"></div>
        <div class="cut-line"></div>

        <div class="v-ornament"><span>✦ ✦ ✦</span></div>

        <h1>Trang không tồn tại</h1>
        <p class="subtitle">Có vẻ đường cắt đã lệch hướng rồi!</p>
        <p class="description">
            Trang bạn tìm kiếm không tồn tại hoặc đã được di chuyển.
            Hãy quay lại trang chủ để tìm những gì bạn cần nhé.
        </p>
