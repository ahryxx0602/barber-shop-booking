    ...
    <nav x-data="{ selected: $persist('Dashboard') }">
      ...
      <div>
        ...
        <ul class="flex flex-col gap-4 mb-6">
          ...
          <!-- ═══ 2. Dịch vụ ═══ -->
          <li>
            <a href="{{ route('admin.services.index') }}" @click="selected = 'DichVu'" class="menu-item group"
              :class="selected === 'DichVu' ? 'menu-item-active' : 'menu-item-inactive'">
              <svg :class="selected === 'DichVu' ? 'menu-item-icon-active' : 'menu-item-icon-inactive'" width="24"
                height="24" viewBox="0 0 24 24" fill="none">
                <path fill-rule="evenodd" clip-rule="evenodd"
          ...
          <!-- ═══ 2b. Sản phẩm (E-commerce) ═══ -->
          <li>
            <a href="{{ route('admin.products.index') }}" @click="selected = 'SanPham'" class="menu-item group"
              :class="selected === 'SanPham' ? 'menu-item-active' : 'menu-item-inactive'">
              <svg :class="selected === 'SanPham' ? 'menu-item-icon-active' : 'menu-item-icon-inactive'" width="24"
              ...
              <span class="menu-item-text" :class="sidebarToggle ? 'lg:hidden' : ''">Sản phẩm</span>
            </a>
          </li>

          <!-- ═══ 2c. Đơn hàng (E-commerce) ═══ -->
          <li>
            <a href="{{ route('admin.orders.index') }}" @click="selected = 'DonHang'" class="menu-item group"
              :class="selected === 'DonHang' ? 'menu-item-active' : 'menu-item-inactive'">
              <svg :class="selected === 'DonHang' ? 'menu-item-icon-active' : 'menu-item-icon-inactive'" width="24"
                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
                stroke-linecap="round" stroke-linejoin="round">
              ...
              <span class="menu-item-text" :class="sidebarToggle ? 'lg:hidden' : ''">Đơn hàng</span>
              @php $pendingOrderCount = \App\Models\Order::where('status', \App\Enums\OrderStatus::Pending)->count(); @endphp
              @if($pendingOrderCount > 0)
                <span class="ml-auto inline-flex items-center justify-center w-5 h-5 text-xs font-bold bg-brand-500 text-white rounded-full" :class="sidebarToggle ? 'lg:hidden' : ''">{{ $pendingOrderCount }}</span>
              @endif
            </a>
          </li>
          ...
          <li>
            <a href="#" @click.prevent="selected = (selected === 'ThoCat' ? '' : 'ThoCat')" class="menu-item group"
              ...
              <svg :class="selected === 'ThoCat' ? 'menu-item-icon-active' : 'menu-item-icon-inactive'" width="24"
                height="24" viewBox="0 0 24 24" fill="none">
                <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <div :class="selected === 'ThoCat' ? 'block' : 'hidden'">
              <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'" class="flex flex-col gap-1 mt-2 pl-9">
                <li>
                  <a href="{{ route('admin.barbers.index') }}" class="menu-dropdown-item group"
