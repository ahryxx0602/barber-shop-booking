...
@section('content')
    <div class="mb-6">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Lịch làm việc</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Cài đặt lịch làm việc hàng tuần của bạn.</p>
            </div>
        </div>
    </div>
    ...
    {{-- Success message --}}
    @if (session('success'))
        <div class="mb-6 px-4 py-3 bg-green-50 border border-green-200 text-green-700 dark:bg-green-900/30 dark:border-green-800 dark:text-green-400 rounded-lg text-sm flex items-center gap-2">
            <svg class="w-5 h-5 text-green-500 dark:text-green-400 shrink-0" fill="currentColor" viewBox="0 0 20 20">
    ...
    <div class="max-w-3xl">
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            {{-- Form --}}
            <form method="POST" action="{{ route('barber.schedule.update') }}"
                ...
                <div class="px-6 py-4 border-t border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 flex items-center justify-between">
                    <p class="text-xs text-gray-400 dark:text-gray-500">
                        Lịch làm việc sẽ được áp dụng cho các slot giờ trong 7 ngày tới.
                    </p>
                    <button type="submit"
        ...
        <div class="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 rounded-lg">
            <div class="flex gap-3">
                <svg class="w-5 h-5 text-blue-500 dark:text-blue-400 shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="text-sm text-blue-700 dark:text-blue-300">
                    ...
                    <ul class="list-disc list-inside space-y-0.5 text-blue-600 dark:text-blue-400">
                        <li>Bật công tắc để đặt ngày làm việc, tắt để nghỉ.</li>
                        <li>Chọn giờ bắt đầu và kết thúc cho mỗi ngày làm việc.</li>
                        <li>Hệ thống sẽ tự động tạo slot giờ (30 phút mỗi slot) dựa trên lịch này.</li>
                        <li>Khách hàng chỉ có thể đặt lịch trong các slot giờ đã tạo.</li>
                    </ul>
                </div>
            </div>
        </div>
