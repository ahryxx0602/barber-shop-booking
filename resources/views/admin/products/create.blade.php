...
@section('content')
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Thêm Sản phẩm mới</h2>
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3"
                                  class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm focus:ring-brand-500 focus:border-brand-500">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="sku" value="{{ old('sku') }}" placeholder="Tự động tạo nếu để trống"
